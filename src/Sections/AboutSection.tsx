  ...
  return (
    <>
      ...
      >
        ...
        <section>
          In the context of medical software, I use TypeScript and React to
          create responsive web applications for{" "}
          <b onClick={() => window.open("https://www.curalie.de", "_blank")}>
            Curalie
          </b>{" "}
          . Plus, I'm a <b>university lecturer</b>, sharing my tech insights
          with the next wave of trailblazers.
        </section>
        <section>
